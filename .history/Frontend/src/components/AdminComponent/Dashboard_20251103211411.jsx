      ...
      <div className="sm:m-24 m-8 grid grid-cols-1 sm:grid-cols-3 gap-8">
        {cards.map((card, index) => (
          ...
          >
            ...
            <Link to={card.link}>
              <button className="mx-auto mb-4 px-5 py-2 text-sm font-medium text-white border border-white rounded-full hover:bg-white hover:text-black transition duration-200 items-center">
                {card.btn}
              </button>
            </Link>
          </div>
