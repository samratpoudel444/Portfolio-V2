...
const LoginComponent = () => {
  return (
    <div className="flex flex-col md:flex-row h-screen w-full">
      <div className="w-full md:w-1/2 h-64  sm:h-full h-screen border bg-[#121212] flex items-center flex-col">
        ...
        <div className="text-center mt-0">
          ...
          <button className="block md:hidden bg-[#121212] text-white px-4 py-2 rounded mt-4 border border-white items-center">
            click here to login
          </button>
        </div>
