...
const Dashboard = () => {
  const cards = [
    { title: "View My Education", color: "bg-black", btn: "Education" },
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="sm:m-24 m-8 grid grid-cols-1 sm:grid-cols-3 gap-8">
        {cards.map((card, index) => (
          <div
            key={index}
            className={`h-56 w-full ${card.color} rounded-2xl shadow-md hover:shadow-xl hover:scale-5 transition transform duration-300 flex flex-col justify-between`}
          >
