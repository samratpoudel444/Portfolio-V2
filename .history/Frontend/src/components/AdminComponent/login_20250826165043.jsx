...
const LoginComponent = () => {
  ...
  return (
    ...
    `}</style>
      ...
      >
        <form className="w-full max-w-md flex flex-col gap-10 justify-center">
          <h1 className="text-3xl font-bold text-center">Login to Site</h1>
          <TextField label="Email" id="fullWidth" className="w-1/2 sm:w-full" />
          <TextField label="Password" id="fullWidth" className="w-1/2 sm:w-full" />
          <Button variant="contained" className=" w-1/2 sm:w-full"> Login</Button>
