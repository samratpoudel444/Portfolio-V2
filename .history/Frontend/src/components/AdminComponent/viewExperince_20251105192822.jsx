...
import ExperincePopUp from "./PopUps/ExperincePopUP";
...
const ViewExperince = () => {
  ...
  useEffect(()=>
  {
    const fetchAllExperince= async()=>
    {
      try{
        const response= await axiosInstance.get('/getExperince');
        setExperince(response.data.data)
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div>
        {openPopUp && <ExperincePopUp id={id} onClose={() => setOpenPopUP(false)} setReload={setReload} />}
      </div>
