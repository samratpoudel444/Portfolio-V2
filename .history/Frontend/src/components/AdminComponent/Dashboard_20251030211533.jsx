  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="sm:m-24 m-8 sm:flex sm:flex-row flex flex-col gap-8">
        ...
        <div className="sm:w-1/3 h-56 w-fullbg-[#8b0000] rounded-2xl shadow-md hover:shadow-xl hover:scale-105 transition transform duration-300 flex flex-col justify-between">
          <div className="flex gap-4 text-white p-4 justify-center items-center">
            <img
              src={Samrat}
              alt="profile"
        ...
        <div className="sm:w-1/3 h-48 rounded-2xl w-full  shadow-md hover:shadow-2xl"></div>
        <div className="sm:w-1/3 h-48 rounded-2xl w-full  shadow-md hover:shadow-2xl"></div>
      </div>
    </div>
  );
