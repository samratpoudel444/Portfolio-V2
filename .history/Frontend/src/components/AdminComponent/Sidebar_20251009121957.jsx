...
const SideBar = () => {
  ...
  // ✅ Reusable Tailwind classes for sidebar buttons
  const buttonClasses =
    "flex items-center gap-4 px-4 py-3 text-lg text-[#F7F7F8] rounded-xl transition-all duration-200 hover:bg-[#004999] hover:translate-x-1";

  return (
    <div className="w-72 h-screen bg-[#202123] flex flex-col justify-between">
      {/* Header */}
