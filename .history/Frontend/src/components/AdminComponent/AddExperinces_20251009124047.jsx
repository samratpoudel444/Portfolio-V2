      ...
      <div className="">
        ...
        <div className="flex justify-center items-center mt-16">
          <form className=" p-4 shadow-lg">
            ...
            <div className="sm:flex sm:flex-row flex flex-col sm:text-2xl text-xl gap-8 items-center jus">
            <button className="border p-2 bg-blue-600 text-white rounded-xl hover:bg-blue-800">Submit</button>
            </div>
          </form>
        </div>
      </div>
