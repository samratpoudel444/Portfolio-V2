...
const LoginComponent = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      <div className={`${showLeft ? "hidden": "w-full md:w-1/2 h-screen md:h-full  bg-[#121212] flex flex-col items-center justify-center gap-10 p-4 " }`}>
        ...
        <div className="text-center w-[50%] sm:w-96">
          ...
          <button className="block md:hidden bg-[#121212] text-white px-4 py-2 rounded border border-white mt-16"
    ...
    `}</style>
      ...
      <div className={`${showLeft}:"w-full md:w-1/2 h-64 md:h-screen border flex justify-center items-center" :"hidden"`}>
        <form className="w-full max-w-md"> mams aaisakyo vanja</form>
      </div>
    </div>
  );
};
