  ...
  return (
    <div className="w-74 h-screen bg-[#202123]">
      ...
      <div className="text-[#F7F7F8] flex flex-col gap-10 mt-10 text-xl ">
        <button className="flex items-center justify-center ml-4 gap-5 px-3 py-3 hover:rounded-2xl mr-4 hover:bg-[#004999] ">
          <DashboardIcon /> Dashboard
        </button>
        <Link to="addeducation">
          <button className="flex justify-center  items-center ml-4 gap-5 px-3 py-3 hover:rounded-2xl mr-4 hover:bg-[#004999] ">
