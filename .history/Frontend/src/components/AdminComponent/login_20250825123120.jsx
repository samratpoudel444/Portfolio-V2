...
const LoginComponent = () => {
    ...
    const [showLeft, setShowLeft]= use
  return (
    <div className="flex flex-col md:flex-row h-screen">
      <div className="w-full md:w-1/2 h-screen md:h-full  bg-[#121212] flex flex-col items-center justify-center gap-10 p-4">
    ...
    `}</style>
      ...
      <div className=" hidden w-full md:w-1/2 h-64 md:h-screen border flex justify-center items-center">
