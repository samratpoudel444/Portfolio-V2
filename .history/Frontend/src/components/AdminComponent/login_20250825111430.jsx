import image from "../../assets/test-removebg-preview copy.png";Frontend/src/assets/Screenshot 2025-08-25 at 11.13.12.png
    ...
    <div className="flex flex-col md:flex-row h-screen w-full">
      <div className="w-full md:w-1/2 h-64  sm:h-full h-full border bg-[#121212] flex items-center flex-col ">
        ...
        <div className="text-center mt-0">
          <p className="text-5xl text-red-50 font-bold whitespace-nowrap overflow-hidden border-r-4 border-red-50 pr-2 animate-typewriter">
            Welcome Back !
          </p>
