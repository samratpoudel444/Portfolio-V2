    ...
    return (
      <div className="">
        ...
        <div className="flex justify-center items-center mt-16 ">
          <form className=" p-4 shadow-2xl rounded-2xl flex flex-col gap-8">
            <div className="sm:flex sm:flex-row flex flex-col sm:text-xl text-lg sm:gap-8 gap-4 items-center">
            ...
            <div className="sm:flex sm:flex-row flex flex-col sm:text-xl text-lg sm:gap-8 gap-4  justify-around items-center">
