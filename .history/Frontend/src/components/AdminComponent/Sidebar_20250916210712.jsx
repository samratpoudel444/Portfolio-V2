...
const SideBar = () => {
  ...
  return (
    <div className="w-74 h-screen bg-[#202123]">
      ...
      <div className="fixed bottom-10 left-0 w-full flex ml-8 gap-3 items-center">
        <button className="flex items-center gap-5 text-xl font-bold text-white px-4 py-4 hover:rounded-2xl hover:bg-[#004999]  ">
          <img
            src="/profile.png"
            alt="Profile"
            className="w-10 h-10 rounded-full border border-gray-400"
          />
          <span className="text-nowrap"> {user.firstName + " " + user.lastName} </span>
        </button>
      </div>
    </div>
  );
