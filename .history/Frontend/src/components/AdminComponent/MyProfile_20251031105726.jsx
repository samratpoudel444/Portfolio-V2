...
const MyProfile= ()=>
{
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="w-2/3 mx-auto mt-16 border flex flex-col justify-center items-center p-16 rounded-2xl bg-gray-200">
            <img src={samrat} alt=""  className="rounded-full w-64 border p-4 bg-white shadow-sm"/>
        </div>
      </div>
    );
}
