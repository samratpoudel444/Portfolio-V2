  ...
  return (
    <div className="w-64 h-screen bg-[#202123]">
      ...
      <div className="text-[#F7F7F8] flex flex-col gap-10 mt-10 text-xl font-bold">
        <button className="flex items-center ml-4 gap-5 py-3 hover:bg-[#000090] hover:text-2xl ">
          <DashboardIcon /> Dashboard
        </button>
        <button className="flex items-center ml-10  gap-5 py-3 hover:bg-[#000090] hover:text-2xl ">
