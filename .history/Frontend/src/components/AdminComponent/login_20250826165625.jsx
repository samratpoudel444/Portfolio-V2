...
import InputAdornment from "@mui/material/Button";
;
...
const LoginComponent = () => {
  ...
  return (
    ...
    `}</style>
      ...
      >
        <form className="w-full max-w-md flex flex-col gap-10 items-center">
          <h1 className="text-3xl font-bold text-center">Login to Site</h1>
          <TextField label="Email" id="fullWidth" className="w-2/3 md:w-full" />
          <TextField label="Password" id="fullWidth" className="w-2/3 md:w-full" type="password" />
          <Button variant="contained" className=" w-2/3 md:w-full"> Login</Button>
          <p className="text-center sm:text-right">
            Forgot Password? <a href="\forgot Password" className="text-blue-700">Click here</a>
          </p>
        </form>
      </div>
    </div>
