  ...
  return (
    <div className="w-74 h-screen bg-[#202123]">
      ...
      <div className="text-[#F7F7F8] flex flex-col gap-10 mt-10 text-xl font-bold">
        <button className="flex items-center ml-4 gap-5 px-3 py-3 hover:border-rounded-2xl mr-4 hover:bg-[#0002343] ">
          <DashboardIcon /> Dashboard
        </button>
        <button className="flex items-center ml-4  gap-3 px-3 py-3 hover:bg-[#000090] hover:text-2xl ">
