    ...
    `}</style>
      ...
      >
        <form className="w-full max-w-md flex flex-col gap-10 items-center">
          ...
          <TextField label="Email" id="fullWidth" className="w-2/3 sm:w-full" />
          <TextField label="Password" id="fullWidth" className="w-2/3 sm:w-full" />
          <Button variant="contained" className=" w-2/2 sm:w-full"> Login</Button>
