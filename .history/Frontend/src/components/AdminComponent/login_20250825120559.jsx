...
const LoginComponent = () => {
  return (
    <div className="flex-1  flex-col md:flex-row h-screen">
      <div className="w-full md:w-1/2 h-full  bg-[#121212] flex flex-col items-center justify-center gap-10 p-4">
        ...
        <div className="text-center sm:w-96 w-48 ">
          ...
          <button className="block md:hidden bg-[#121212] text-white px-4 py-2 rounded mt-8 border border-white mt-16">
            Click here to login
          </button>
        </div>
