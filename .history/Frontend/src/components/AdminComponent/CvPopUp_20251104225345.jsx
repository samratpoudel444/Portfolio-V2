        ...
        <div className="h-full mt-16">
          ...
          >
            ...
            <input
              ...
              placeholder="Provide CV Link"
              className="w-1/2 rounded-2xl border file:border file:rounded-2xl p-4"
            />
            <button
              type="submit"
              disabled={loading}
              className={` px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 ${loading ""}`}
            >
