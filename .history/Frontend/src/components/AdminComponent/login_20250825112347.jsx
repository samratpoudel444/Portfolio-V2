...
const LoginComponent = () => {
  return (
    <div className="flex flex-col md:flex-row h-screen">
      <div className="w-screen md:w-1/2 h-64  sm:h-full h-full border bg-[#121212] flex items-center flex-col ">
        <div className="border-red-200 items-center">
          <img src={image} className="w-2/3 justify-start items-center" />
        </div>
        <div className="text-center mt-0 w-2/3">
