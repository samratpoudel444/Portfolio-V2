  ...
  const updateData= async()=>
{
  try{
    ...
    const res= await axiosInstance.post('/createProject', formData,{
      headers:{
          ...
          >
            <div className="sm:flex sm:flex-row flex flex-col gap-4 justify-start items-center">
              ...
              <input
                type="text"
                name="ProjectName"
                className="border rounded-2xl p-2 w-full sm:w-1/2"
            ...
            <div className="sm:flex sm:flex-row flex flex-col gap-4 justify-start items-center">
              ...
              <input
                type="file"
                className="border rounded-2xl p-2 w-full sm:w-1/2 file:rounded-2xl file:border file:p-1 file:bg-blue-100 file:text-sm file:font-bold file:text-blue-700"
                placeholder="Enter project name"
                name="ProjectImage"
                onChange={handleChange}
              />
            ...
            <div className="sm:flex sm:flex-row flex flex-col gap-4 justify-start items-center">
              ...
              <input
                type="text"
                className="border rounded-2xl p-2 sm:w-1/2 w-full "
                placeholder="Enter project name"
                name="ProjectLink"
                onChange={handleChange}
              />
