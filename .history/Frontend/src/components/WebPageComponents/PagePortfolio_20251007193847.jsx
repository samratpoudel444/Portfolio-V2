      ...
      <div>
        ...
        <div className="">
          ...
          <div className="mt-16 bg-gray-300 flex flex-col p-8">
            ...
            <div className="sm: grid sm:grid-cols-3 flex flex-col mt-16 sm:gap-8 gap-4 rounded-2xl">
              {MyTask.map((items, count) => (
                <div key={count} className="border">
                  <img src={items.image} alt={items.title} className="" />
                  <a>{items.title}</a>
                  <p>
                    <TruncatedText text={items.description} />
                  </p>
                </div>
              ))}
            </div>
