      ...
      <div className="flex flex-col">
        ...
        <div className="grid grid-cols-2 mt-16 gap-8">
          {projects.map((data, index) => (
            <div
              key={index}
              className="flex flex-col rounded-4xl p-8 justify-center items-center bg-white shadow-transparent  hover:shadow-md"
            >
              <img src={data.img} alt="" className="h-120 w-120 rounded-3xl"/>
