...
import <Samrat2></Samrat2> from "../../assets/samrat1.png";
const HomeSection = () => {
  return (
    <div className="sm:flex sm:mt-16 sm:mx-auto sm:w-[80%] gap-16">
      <div className="">
      ...
      <div className="flex items-center justify-center w-1/2">
        <div className="rounded-full bg-yellow-500 w-100 h-100">
          <img src={samrat1} alt="samrat poudel" />
        </div>
      </div>
    </div>
  );
