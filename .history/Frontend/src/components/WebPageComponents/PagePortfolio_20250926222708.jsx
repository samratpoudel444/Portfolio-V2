    ...
    return (
      <div>
        ...
        <div className=" p-8">
          ...
          <div className="sm:flex sm:flex-row flex flex-col sm:p-16 px-4 py-8 justify-between">
            <div className="flex flex-col rounded-2xl bg-gray-100 shadow-lg hover:shadow-2xl gap-4 sm:p-16 p-4">
