      ...
      <div className="flex flex-col">
        ...
        <div className="md:grid sm:grid-cols-3 md:mt-16 sm:gap-8 flex flex-col gap-4 mt-8">
          {data.map((data, index) => (
            <div
              key={index}
              className="flex flex-col rounded-4xl p-8 justify-between items-center bg-white shadow-md  hover:shadow-2xl"
            >
              <img src={data.ProjectImage} alt="" className="rounded-3xl" />
              <h1 className="mt-4 text-2xl font-bold">{data.ProjectName}</h1>
