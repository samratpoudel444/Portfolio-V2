...
const HomeSection = () => {
  return (
    <div className="sm:flex sm:mt-16 sm:mx-auto sm:w-[80%] gap-16 py-10 sm:justify-between">
      <div className="">
        <div className="border-4 border-yellow-400 h-16 w-48 text-center sm:text-3xl py-2 text">
          Hello There!
        </div>
      ...
      <div className="flex items-center justify-center w-1/2">
        <div className="rounded-full bg-yellow-500 w-[420px] h-[420px]"></div>
        <img
          src={Samrat}
          alt="samrat poudel"
          className="absolute z-10 w-[500px] h-[500px] ml-8"
        />
        <button></button>
      </div>
    </div>
