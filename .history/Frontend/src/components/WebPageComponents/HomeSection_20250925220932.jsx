...
const HomeSection = () => {
  return (
    <div className="sm:flex sm:flex-row sm:mt-16 sm:mx-auto sm:w-[80%] gap-16 py-10 sm:justify-between mx-8 flex flex-col-reverse ">
      <div className="flex flex-col justify-center items-center sm:justify-start sm:items-start">
        ...
        <div className="flex flex-row mt-16 gap-8">
          <button className="bg-yellow-500 rounded-3xl px-1  sm:flex gap-4 items-center hover:underline">
