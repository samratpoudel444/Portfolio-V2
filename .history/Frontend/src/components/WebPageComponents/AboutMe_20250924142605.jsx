...
and build digital solutions that impact people's lives positively. 
Both interests fuel my drive for continuous learning and improvement, whether on the field or in front of a computer screen. 
They complement each other, with football offering an outlet for physical energy 
...
const AboutMe = () => {
  return (
    <div className="mt-16 w-full flex flex-col md:flex-row items-center px-8 md:px-16 gap-12 bg-green-900 py-16">
      ...
      <div className="text-white text-lg md:text-xl whitespace-pre-line">
      <h1 className="gap-3">About Me</h1>
        {data[0].Description}
      </div>
    </div>
  );
