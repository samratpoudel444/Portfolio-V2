    ...
    return (
      <div className="">
        <div>
          <div>
            <h1>
              Let's <a className="text-yellow-500">Connect</a>there
            </h1>
          </div>
        ...
        <div className="w-screen bg-green-900 text-white sm:flex-row justify-between sm:px-16 sm:text-xl flex flex-col py-4">
          <span>
