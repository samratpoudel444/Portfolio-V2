    ...
    return (
      <div>
        ...
        <div className=" p-8">
          ...
          <div className="sm:flex sm:flex-row flex flex-col sm:p-16 sm:px-4 sm:py-8 py-4 justify-between gap-8">
            <div className="flex flex-col rounded-2xl bg-gray-100 shadow-lg hover:shadow-2xl gap-4 sm:p-16 p-8">
              <h1 className="flex sm:text-4xl text-2xl items-center gap-8 p-2 border-b-1 border-gray-400">
            ...
            <div className="flex flex-col rounded-2xl bg-gray-100 shadow-lg hover:shadow-2xl gap-4 p-8">
              <h1 className="flex sm:text-4xl items-center text-2xl gap-8 p-2 border-b-1 border-gray-400">
                <div className="bg-yellow-500 flex items-center rounded-full p-2">
                  <SchoolIcon />
                </div>
                Work Experince
              ...
              {WorkExperince.map((data, index) => (
                <div
                  key={index}
                  className="flex flex-col text-xl gap-2 border-l-2 p-4 border-gray-400"
                >
                  <a className="text-gray-400">{data.year}</a>
