  ...
  return (
    <div className="mt-16 bg-gray-100 p-16">
      <div className="flex flex-col">
        ...
        <div className="sm:flex sm:flex-row flex-col gapy-y-4 mt-8 sm:justify-between">
          <h1 className="sm:text-4xl text-2xl">
            My Latest <a className="text-yellow-500">Projects</a>
          </h1>
          <button className="border rounded-4xl py-1 bg-green-900 flex items-center mt-4">
