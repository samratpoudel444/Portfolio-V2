...
const ToolsUsed= ()=>
{
    return(
        <div className="mt-16">
            ...
            (
                <div key={index} className="border-2 rounded-2xl p-6 flex flex-col justify-center items-center gap-4">
                    <img src={data.img} alt={data.name} className="border-2 h-16 w-16 rounded-full" />
                    <h1>{data.name}</h1>
                </div>
            ))}
            </div>
