...
const services = [
  ...
  },
  {
    ...
    description:
      "Creating backend for mobile applications for iOS and Android platforms.",
    icon: "📱",
  },
  {
    title: "UI/UX Design",
    ...
    <div className="mt-16 mx-40">
      ...
      <div className="grid grid-cols-3 gap-8">
        {services.map((service, index) => (
          <div key={index} className="border-2 p-6 rounded-2xl hover:shadow-lg">
            <div className="text-4xl mb-4 bg-grey-500">{service.icon}</div>
