...
const AboutMe = () => {
    return (
      <div className="mt-16 w-full h-96  bg-green-900 flex items-center px-16">
        <div className="rounded-full  w-64 h-64 bg-yellow-500 flex items-center ">
          <img src={Samrat} alt="" className="w-full h-full object-cover" />
        </div>
      </div>
    );
