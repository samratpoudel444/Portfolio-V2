...
const services = [
  ...
  },
  {
    ...
    description:
      "Creating mobile applications for Android platforms.",
    icon: "📱",
  },
  {
    title: "UI/UX Design",
    ...
    <div className="mt-16 mx-40">
      <div className="flex justify-between items-center mb-12">
        <div>
          ...
          <h1 className="font-bold  font-italic text-4xl">Services I provide</h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-8">
        {services.map((service, index) => (
          <div
            key={index}
            className="border-2 p-6 rounded-2xl hover:shadow-lg bg-grey-800"
          >
