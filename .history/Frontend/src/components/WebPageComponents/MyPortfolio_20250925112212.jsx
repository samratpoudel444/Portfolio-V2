        ...
        <div className="grid grid-cols-3 mt-16 gap-8">
          {projects.map((data, index) => (
            ...
            >
              ...
              <button className="p-2 border mt-4 bg-green-900 rounded-2xl w-1/2 text-white font-bold flex">
                <div className="bg-yellow-500 rounded-2xl text-black">View Project</div>
                a
              </button>
            </div>
          ))}
